...
/***/ function(module, exports, __webpack_require__) {
	...
	var CoverageBar = __webpack_require__(5);
	var Tooltip = __webpack_require__(55);
	var OverlayTrigger = __webpack_require__(40);
	...
	var RangeFinder = React.createClass({displayName: "RangeFinder",
	  ...
	  makeTicks: function(snapGrid) {
	    ...
	    for(var key in snapGrid) {
	      ...
	      ticks.push(React.createElement("line", {key: "tick"+key, x1: x, y1: y1, x2: x, y2: y2, strokeWidth: "1", stroke: "grey"}));
	    }
	  ...
	  makeCoverage: function() {
	    ...
	    return this.seriesMapping.map(function(series, id) {
	      ...
	      var seriesText = React.createElement("span", {dangerouslySetInnerHTML: {__html: seriesText}})

	      var tooltip = (React.createElement(Tooltip, {arrowOffsetLeft: "30%", arrowOffsetTop: -5}, seriesText));

	      return (
	          React.createElement("g", {key: "coverage" + id}, 
	  ...
	  makeCoverageGrouping: function() {
	    ...
	    return this.seriesGrouping.map(function(grouping, id) {
	      ...
	      var tooltip = React.createElement(Tooltip, {arrowOffsetLeft: "30%", arrowOffsetTop: -5}, grouping.categoryName)

	      return (
	        React.createElement("g", {key: "grouping" + id}, 
	          React.createElement(OverlayTrigger, {placement: "bottom", overlay: tooltip}, 
	            React.createElement("text", {x: textX, y: textY, textAnchor: "end"}, name)
	          ), 
	          React.createElement("polyline", {fill: "none", stroke: "black", strokeWidth: "1", points: points})
	        )
	      );
	    }, this);
	  },
	  ...
	  render: function() {
	    ...
	    return (
	      React.createElement("svg", {id: this.props.id, width: width, height: height}, 
	        React.createElement("g", null, ticks), 
	        React.createElement("text", {x: this.barX - this.consts.textMargin, y: this.barY + this.props.barHeight, textAnchor: "end"}, this.props.start), 
	        React.createElement("rect", {x: this.barX, y: this.barY, width: this.props.barWidth, height: this.props.barHeight, fill: "darkgreen", stroke: "darkgreen"}), 
	        React.createElement("text", {x: this.barX + this.props.barWidth + this.consts.textMargin, y: this.barY + this.props.barHeight, textAnchor: "start"}, this.props.end), 
	        coverage, 
	        coverageGrouping, 
	        sliders
	      )
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({displayName: "exports",
	  ...
	  render: function() {
	    ...
	    return (
	      React.createElement("g", {className: "slider"}, 
	        React.createElement("text", {x: x, y: handleY - textMargin, textAnchor: handleAnchor === 0 ? "start" : "end"}, this.state.value), 
	        React.createElement("rect", {x: handleX, y: handleY, width: handleSize, height: handleSize, strokeWidth: "2", stroke: "black"}), 
	        React.createElement("line", {x1: x, y1: y, x2: x, y2: y + height, strokeWidth: "2", stroke: "black"}), 
	        React.createElement("rect", {x: handleX, y: handleY + height, width: handleSize, height: handleSize, strokeWidth: "2", stroke: "black"})
	      )
	    )
	  }
	});
	  ...
	  render: function() {
	    ...
	    return (
	      React.createElement("g", null, 
	        React.createElement("line", {x1: x1, y1: y, x2: x2, y2: y, strokeWidth: "1", stroke: this.props.color, strokeDasharray: "5, 5"}), 
	        bars
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var OverlayMixin = __webpack_require__(41);
	var domUtils = __webpack_require__(59);
	var cloneWithProps = __webpack_require__(63);

	var createChainedFunction = __webpack_require__(65);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var CustomPropTypes = __webpack_require__(67);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var joinClasses = __webpack_require__(58);
	var classSet = __webpack_require__(61);
	var BootstrapMixin = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		module.hot.accept("!!/Users/stephensmith/Desktop/gitRepos/react-range-finder/node_modules/css-loader/index.js!/Users/stephensmith/Desktop/gitRepos/react-range-finder/tooltip.css", function() {
			var newContent = require("!!/Users/stephensmith/Desktop/gitRepos/react-range-finder/node_modules/css-loader/index.js!/Users/stephensmith/Desktop/gitRepos/react-range-finder/tooltip.css");
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.push([module.id, "/* Much (if not all) taken from http://react-bootstrap.github.io/components.html */\n\n.tooltip-inner {\n  max-width: 200px;\n  padding: 3px 8px;\n  color: #fff;\n  text-align: center;\n  background-color: #000;\n  border-radius: 4px;\n}\n\n.tooltip {\n  position: absolute;\n  font-size: 12px;\n  line-height: 1.4;\n  margin: 5px;\n  visibility: visible;\n}\n\n.tooltip.bottom .tooltip-arrow {\n  border-width: 0px 5px 5px 5px;\n  border-bottom-color: #000;\n}\n\n.tooltip-arrow {\n  position: absolute;\n  width: 0;\n  height: 0;\n  border-color: transparent;\n  border-style: solid;\n}", ""]);
